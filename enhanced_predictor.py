"""
Enhanced Lane Predictor with Robust Model Loading
Uses the ModelLoader for better compatibility
"""
...
class EnhancedLanePredictor:
    ...
    def load_model(self, model_path):
        ...
        if success:
            ...
            # Try to create a compatible model
            print("Attempting to create compatible model...")
            if self.model_loader.create_compatible_model(self.input_shape):
                self.model = self.model_loader.model
                self.load_successful = True
...
def test_enhanced_predictor():
    ...
    print("Testing Enhanced Lane Predictor...")
    print("-" * 50)
    ...
    if predictor.is_model_loaded():
        ...
        print("✗ Enhanced predictor creation failed!")
